    ...
    <div class="container">
        <div class="dashboard-card">
            ...
            <div class="dashboard-header">
                ...
                <h3>Viewing Panel: <span style="color: #1e56ce; font-weight: 700;"><?php echo e($username); ?></span></h3>
            </div>
            ...
            <div class="stats-grid">
                <div class="stat-box assigned">
                    <div class="stat-info">
                        ...
                        <p id="stat-assigned"><?php echo e($assignedCount); ?></p>
                    </div>
                ...
                <div class="stat-box pending">
                    <div class="stat-info">
                        ...
                        <p id="stat-pending"><?php echo e($pendingCount); ?></p>
                    </div>
                ...
                <div class="stat-box resolved">
                    <div class="stat-info">
                        ...
                        <p id="stat-resolved"><?php echo e($resolvedCount); ?></p>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr id="ticket-row-<?php echo e($ticket->Id); ?>">
                            ...
                            <td>
                                ...
                                <div style="font-size: 12px; color: #64748b; margin-top: 2px;">Assigned To: <?php echo e($ticket->assigned_to); ?></div>
                            </td>
                            ...
                            <td>
    <?php if(strtolower($ticket->Status_name) == 'assigned'): ?>
        <span class="badge status-assigned" id="table-status-badge-<?php echo e($ticket->Id); ?>"><i class="fa-solid fa-user-check"></i> Assigned</span>
    <?php elseif(strtolower($ticket->Status_name) == 'pending' || strtolower($ticket->Status_name) == 'in progress'): ?>
        <span class="badge status-progress" id="table-status-badge-<?php echo e($ticket->Id); ?>"><i class="fa-solid fa-spinner fa-spin"></i> Pending</span>
    <?php elseif(strtolower($ticket->Status_name) == 'resolved'): ?>
        <span class="badge status-resolved" id="table-status-badge-<?php echo e($ticket->Id); ?>"><i class="fa-solid fa-circle-check"></i> Resolved</span>
    <?php else: ?>
        <span class="badge status-assigned" id="table-status-badge-<?php echo e($ticket->Id); ?>"><?php echo e($ticket->Status_name); ?></span>
    <?php endif; ?>
</td>
    <td>

    <?php if(strtolower($ticket->Status_name) !== 'resolved' && strtolower($ticket->Status_name) !== 'closed'): ?>
    <button class="action-btn" 
            onclick="openDetailPanel(
                '<?php echo e($ticket->Id); ?>', 
                '<?php echo e(addslashes($ticket->Subject)); ?>', 
                '<?php echo e(json_encode($ticket->description)); ?>', 
                '<?php echo e(addslashes($ticket->Status_name)); ?>'
            )">
...
<?php else: ?>
    ...
    <?php endif; ?>
                    ...
                    <td>
    <a href="<?php echo e(url('support/tickets/show/' . urlencode(Crypt::encryptString($ticket->Id ?? $ticket->id)))); ?>" class="btn-show-details" style="display: inline-flex; align-items: center; gap: 6px; background-color: #0c369a; color: white; padding: 6px 12px; border-radius: 4px; font-size: 12px; text-decoration: none; font-weight: 500;">
...
</html><?php /**PATH C:\internship\project1\resources\views/support_dash.blade.php ENDPATH**/ ?>